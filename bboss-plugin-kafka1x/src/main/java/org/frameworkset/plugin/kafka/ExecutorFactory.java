...
public final class ExecutorFactory {
    ...
    private static final ThreadFactory DEFAULT_THREAD_FACTORY = new KafkaThreadFactory("Pinpoint-defaultThreadFactory", true);
    ...
    public static ThreadPoolExecutor newFixedThreadPool(int nThreads, int workQueueMaxSize, String threadFactoryName, boolean daemon) {
        ThreadFactory threadFactory = new KafkaThreadFactory(threadFactoryName, daemon);
